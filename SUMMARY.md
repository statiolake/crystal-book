...
* [インストール](installation/README.md)
   * [Debian / Ubuntu](installation/on_debian_and_ubuntu.md)
   * [RedHat / CentOS](installation/on_redhat_and_centos.md)
   * [Arch Linux](installation/on_arch_linux.md)
   * [Gentoo Linux](installation/on_gentoo_linux.md)
   * [Mac OSX (Homebrew)](installation/on_mac_osx_using_homebrew.md)
   * [Linux (Linuxbrew)](installation/on_linux_using_linuxbrew.md)
   * [Bash on Ubuntu on Windows](installation/on_bash_on_ubuntu_on_windows.md)
   * [tar.gz から](installation/from_a_targz.md)
   * [ソースから](installation/from_source_repository.md)
